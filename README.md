...
- **PWA Ready**: Works completely offline via robust Service Worker caching and LocalStorage fallbacks. Features Network-First caching so you always get the latest code.
...
└── js/                   → Application Logic
    ├── ai/               → LLM Prompts, Context Builder, Intent parsing
...
2. Map the implementation in the `ExecutionRegistry` object inside `registry.js`.
