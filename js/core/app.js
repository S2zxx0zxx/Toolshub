...
const Settings = (() => {
  ...
  function init() {
    ...
    document.getElementById('agentIntroStartBtn')?.addEventListener('click', function() {
      ...
      const agentIntroState = document.getElementById('agentIntroState');
      const emptyState = document.getElementById('emptyState');
      const msgList = document.getElementById('msgList');
      if (agentIntroState) agentIntroState.style.display = 'none';
  ...
  function updatePlanUI() {
    ...
    if (agentModeBadge) {
      if (!BottomSheet.userCanAccess('monthly')) {
        ...
        agentModeBadge.classList.add('badge-pro');
        ...
        agentModeBadge.classList.remove('badge-pro');
